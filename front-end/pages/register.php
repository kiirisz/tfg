    ...
    <body class="font-dmono ">
        ...
        <main class="h-screen  w-full flex flex-col items-center bg-gradient-to-br to-blue-500 from-green-500">
            ...
            <div class="text-slate-800 bg-slate-200 flex flex-col items-center text-center my-auto px-5 rounded-md p-5">
                ...
                <form action="" method="post" class="my-auto">
                    ...
                    <input type="email" name="email" id="email" class="bg-inherit border-b-slate-400 border-solid border-2 hover:border-b-slate-600 transition ease-in-out "><br><br>

                    <label for="date" class="text-2xl">Date of Birth</label><br>
                    <input type="date" name="date" id="date" class="bg-inherit border-b-slate-400 border-solid border-2 hover:border-b-slate-600 transition ease-in-out "><br><br>

                    <label for="phone" class="text-2xl">Phone Number</label><br>
                    <input type="text" name="phone" id="phone" class="bg-inherit border-b-slate-400 border-solid border-2 hover:border-b-slate-600 transition ease-in-out "><br><br>
